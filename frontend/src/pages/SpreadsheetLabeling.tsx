        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            <div>
                ...
                <ul className="space-y-1 text-slate-600">
                    <li><strong>Step 0:</strong> Greeting & Language Preference</li>
                    <li><strong>Step 1:</strong> History taking</li>
                    <li><strong>Step 2:</strong> Pre-Eye Testing & detail confirmation</li>
                    ...
                    <li><strong>Step 6:</strong> New Prescription Verification</li>
                    <li><strong>Step 7:</strong> Power Updation</li>
                    <li><strong>Step 8:</strong> Power Explanation</li>
                    <li><strong>Step 9:</strong> Handover</li>
                </ul>
            </div>
            <div>
